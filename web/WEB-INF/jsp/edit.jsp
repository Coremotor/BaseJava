...
<%@ page import="com.urise.webapp.model.SectionsType" %>
        ...
        <form method="post" action="resume" enctype="application/x-www-form-urlencoded">
            ...
            <dl>
                <input name="fullName" type="text"
                       pattern="^[A-Za-z]+([\s][A-Za-z]+)*$" required size="50" value="${resume.fullName}">
            </dl>
            <h2>Контакты:</h2>
            ...
            <hr>
            <c:forEach var="type" items="<%=SectionsType.values()%>">
                                    ...
                                    <dl>
                                        ...
                                        <dd>
                                            <input type="text" name="${type}${counter.index}startDate" size=10
                                                   value="<%=DateUtil.format(periods.getStartDate())%>"
                                                   placeholder="MM/yyyy">
                                        </dd>
                                    </dl>
                                    <dl>
                                        ...
                                        <dd>
                                            <input type="text" name="${type}${counter.index}endDate" size=10
                                                   value="<%=DateUtil.format(periods.getEndDate())%>"
                                                   placeholder="MM/yyyy">
                                    </dl>
                                    <dl>
                                        <dt>Должность:</dt>
